...
Dashboard
- A Lovelace dashboard file with updated entity ids is available at `dashboards/uvr_dashboard.yaml`.
  Import it into HA via the Raw editor or copy it into your `lovelace` folder.
...
Thank you — if you want the dashboard adjusted (graphs, gauges, layout), tell me which widgets you prefer and I'll update the YAML.